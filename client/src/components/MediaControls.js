...
const MediaControls = (props) => {
    ...
    const muteSelf = () => {
        ...
        if(muted === "audio-button-true"){
            ...
            props.userAudio.current[0].enabled = false;
        }else{
            setMuteIcon("audio-button-true");
            props.userAudio.current[0].enabled = true;
        }
    ...
    const disableVideo = () => {
        ...
        if(videoIcon === "video-button-true"){
            ...
            props.userVideoStream.current[0].enabled = false;
        }else{
            setVideoIcon("video-button-true");
            props.userVideoStream.current[0].enabled = true;
    ...
    return (
        <section className="media-controls">
                ...
                <button onClick={props.hangup} className="hangup-button">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="svg">
                        <path
