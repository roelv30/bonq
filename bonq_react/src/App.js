		...
		return (
			<HashRouter>
					<Switch>
						...
						<PrivateRoute exact path="/host/questions" component={InsertQuestionsForm} isAuthenticated={this.state.isAuthenticated} token={this.state.token} refresh={this.refresh} logout={this.logout} />
					</Switch>
